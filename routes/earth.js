...
router.get("/getQuakesGivenRange", (req, res) => {
    ...
    var lowerLimit = Number = req.query.lat_first
    var val1 = val2;
    var val2 = val1 + range;
    var result = [];
   ...
   function exesql(val1,val2,range,i) {
    ...
    var sql = `Select count(mag) as count from earthquake where latitude between ${lowerLimit} and ${upperLimit} group by latitude`;
    if(i==range){
